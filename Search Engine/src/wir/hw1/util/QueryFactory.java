...
public class QueryFactory {
    ...
    public QueryFactory(JSONObject config) {
        this.tokenizer = new Tokenizer(config.getJSONObject("dict_path").getString("mmseg"));
        System.setProperty("wordnet.database.dir", config.getJSONObject("dict_path").getString("wordnet"));
